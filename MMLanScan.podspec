...
Pod::Spec.new do |s|
  s.name             = 'MMLanScan'
  s.version          = '0.1.0'
  s.summary          = 'A short description of MMLanScan.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/MMLanScan'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Michael Mavris' => 'michaelmavris@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/MMLanScan.git', :tag => s.version.to_s }
